...
const HomePage = () => {
  ...
  const images = [hero1, hero2, hero1];
  ...
  return (
    <div>
      ...
      >
        ...
        <div
          className="md:w-[58%] w-full relative before:content-[''] before:absolute before:inset-0 before:bg-cover before:bg-center before:opacity-20 before:z-0 flex items-center px-12"
          style={
            {
              "--bg-image": `url(${heroBg})`,
        ...
        >
          <div className="relative z-10">
            ...
            >
              At Total Compact Ltd, we are committed to driving sustainable
              growth through innovation, strategic expertise, and unwavering
              integrity. While real estate remains a cornerstone of our
              operations, our capabilities extend across diverse sectors,
              including technology and integrated business solutions.
            </motion.p>
      ...
      <motion.section className="container mx-auto flex flex-col md:flex-row lg:min-h-screen md:min-h-[30vh] py-8 px-4 items-center gap-8">
        ...
        <div className="w-full md:w-1/2">
          ...
          >
            With over decades of experience in real estate development, we've
            helped countless families find their perfect homes. Our commitment
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-8">
            ...
            >
              ...
              <div className="absolute bottom-4 left-4 right-4 bg-white p-6 rounded-xl shadow-lg transition-all duration-300 group-hover:bg-tertiary">
                ...
                <p className="text-gray-600 group-hover:text-white/90">
                  Professional management services for your real estate
                  investments.
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="absolute bottom-4 left-4 right-4 bg-white p-6 rounded-xl shadow-lg transition-all duration-300 group-hover:bg-primary">
                ...
                <p className="text-gray-600 group-hover:text-white/90">
                  Get expert advice from our experienced consultant in real
                  estate construction and tech industry.
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="absolute bottom-4 left-4 right-4 bg-white p-6 rounded-xl shadow-lg transition-all duration-300 group-hover:bg-secondary">
                ...
                <p className="text-gray-600 group-hover:text-white/90">
                  Advanced technology integration for modern construction and
                  property management.
                </p>
              </div>
            </motion.div>
      ...
      <motion.section className="bg-white py-16">
        <div className="container mx-auto px-4">
            ...
            {[
              {
                ...
                description:
                  "With over 20 years of excellence in real estate, we've built a reputation for delivering exceptional results.",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
              ...
              },
              {
                ...
                description:
                  "Your dreams and satisfaction are our top priority. We tailor our services to meet your unique needs.",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
              ...
              },
              {
                ...
                description:
                  "We leverage cutting-edge technology and market insights to provide you with the best opportunities.",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
          ...
          >
            ...
            <Link
              to="/contact"
              className="bg-tertiary text-white px-8 py-3 rounded-lg hover:bg-tertiary/90 transition-colors"
            >
              Contact Us Today
            </Link>
          </motion.div>
      ...
      <motion.section className="py-16 bg-gray-100">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div
              className="hidden md:block md:w-1/2 relative before:content-[''] before:absolute before:inset-0 before:bg-cover before:bg-center before:opacity-90 before:z-0 min-h-[400px] rounded-2xl overflow-hidden"
              style={{
