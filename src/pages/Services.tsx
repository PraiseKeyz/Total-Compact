...
const serviceData = [
  {
    ...
    description:
      "Delivering strategic real estate solutions with a focus on value creation and long-term returns. TC Real Estate leverages market intelligence, professional insights, and networked partnerships to support clients in acquisition, sales, and asset optimization.",
    offerings: [
  ...
  },
  {
    ...
    description:
      "From concept to completion, we provide reliable and innovative construction services tailored to your project’s needs. Our teams ensure architectural integrity, structural safety, and delivery excellence across all phases of development.",
    offerings: [
  ...
  },
  {
    ...
    title: "TC Motors",
    description:
      "Your trusted mobility partner. TC Motors provides reliable automotive solutions—from sales and maintenance to fleet services—tailored for performance, comfort, and safety on the road.",
    offerings: [
  ...
  },
  {
    ...
    description:
      "Driving digital transformation through innovative technology solutions. TC Technologies delivers cutting-edge IT infrastructure, smart systems, and digital platforms that power growth, efficiency, and resilience.",
    offerings: [
  ...
  },
  {
    ...
    description:
      "We build scalable, user-centric software solutions and manage projects with precision. Our approach combines agile methodologies, strategic oversight, and seamless execution to ensure your ideas reach their full potential.",
    offerings: [
  ...
  },
  {
    ...
    title: "TC Farm",
    description:
      "Committed to sustainable agriculture and food security, TC Farm cultivates quality produce and livestock through eco-conscious farming practices, innovation, and responsible agribusiness operations.",
    offerings: [
  ...
  },
  {
    ...
    title: "TC Graphics",
    description:
      "Where ideas meet visuals. TC Graphics offers professional design and branding solutions that tell compelling stories, reinforce identity, and drive engagement across all mediums.",
    offerings: [
  ...
  },
  {
    ...
    description:
      "Blending personal care and modern fashion to promote wellness and confidence. Our offerings reflect quality, creativity, and a commitment to empowering lifestyles with elegance and authenticity.",
    offerings: [
  ...
  },
  {
    ...
    title: "TC Foods",
    description:
      "Delivering fresh, quality foods and catering solutions that nourish communities. From farm-to-table products to dynamic food services, TC Foods blends nutrition with excellence.",
    offerings: [
  ...
  },
  {
    ...
    description:
      "Empowering businesses and professionals through expert consultancy and tailored training programs. Our focus is on delivering practical knowledge, strategic insights, and transformative learning experiences across industries.",
    offerings: [
...
const Services = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section */}
      <div
        className="relative h-[60vh] py-24 bg-black/60 bg-blend-overlay"
        style={{
      ...
      >
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl text-white/90 max-w-2xl">
            Comprehensive solutions for all your real estate and construction
            needs, delivered with expertise and dedication.
          </p>
        </div>
      </div>
      ...
      <div className="bg-gray-900 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <Link
            to="/contact"
            className="bg-primary text-white py-3 px-8 rounded-lg hover:bg-primary/90 transition-colors"
          >
            Contact Us Now
          </Link>
        </div>
