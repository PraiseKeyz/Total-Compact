  ...
  const investmentOptions = [
    {
      title: "Land Projects",
      description:
        "Secure fast growing land properties (through our Landee platform or estate schemes",
      timeframe: "2-5 years",
    },
    {
      title: "Fix & Flip Projects",
      description:
        "We acquire distressed properties, renovate them, and resell at market value",
        ...
        <div className="container mx-auto px-6 lg:px-10 space-y-20 relative">
          <div className="text-center mb-16">
            ...
            >
              ...
              <span className="text-tertiary font-semibold tracking-wider text-sm uppercase">
                PARTNERSHIP
              </span>
            </motion.div>
            ...
            >
              <div className="space-y-6">
                <h3 className="text-2xl font-semibold text-gray-900">
                  Invest. Build. Earn. With Zero Stress
                </h3>
                <p className="text-gray-600 leading-relaxed">
                  At Total Compact, we believe that real estate should be a
                  wealth-building tool for everyone not just developers. Our
                  Investment & Partnership Program offers you the opportunity to
                  earn consistent returns by partnering with us on real estate
                  projects while we do the heavy lifting.
                </p>
                <p className="text-gray-600 leading-relaxed">
                  We stand as a beacon of excellence in construction, interior
                  design, and renovations. With a proven track record of
                  successful projects and sustainable growth, we offer diverse
                ...
                <div className="grid grid-cols-2 gap-6 mt-8">
                  <div className="border-l-4 border-tertiary pl-4 py-3 bg-white/50 rounded-r-lg hover:bg-white/80 transition-all duration-300">
                    ...
                    <p className="text-gray-600 text-sm leading-relaxed">
                      We transform undervalued properties into profitable
                      investments through strategic renovation and development.
                    </p>
                  </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.6 }}
              className="hidden lg:block absolute top-180 bottom-0 left-1/2 w-1 h-80 bg-primary"
            ></motion.div>
            <motion.div
              initial={{ x: -50, opacity: 0 }}
              whileInView={{ x: 0, opacity: 1 }}
            ...
            >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-8">
                {investmentOptions.map((option, index) => (
                  <div
                    key={index}
                    className="bg-white p-6 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 transform hover:-translate-y-1"
                  >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 text-center">
                <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-100 text-left">
                  ...
                  <p className="text-sm text-gray-600">
                    Our projects have historically delivered returns ranging
                    from 8-30% annually
                  </p>
                ...
                <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-100 text-left">
                  ...
                  <p className="text-sm text-gray-600">
                    Creating jobs, improving infrastructure, and contributing to
                ...
                <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-100 text-left">
                  ...
                  <p className="text-sm text-gray-600">
                    Committed to eco-friendly construction practices and
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-lg text-gray-600 mb-8">
                Join our network of successful investors and be part of our next
                project
              </p>
